        ...
        <div className="col-xl-4 col-md-6" style={{ marginBottom: '30px' }} key={index}>
          <div className="destination-item tour-grid style-three bgc-lighter">
            <div className="image">
              ...
              <Link to="#" className="heart"><i className="fas fa-heart"></i></Link>
            ...
            <div className="content">
              ...
              <h6><Link to={`/tour-detail/${tour.tourId}`}>{tour.title}</Link></h6>
              ...
              <div className="destination-footer">
                ...
                <Link to={`/tour-detail/${tour.tourId}`} className="theme-btn style-two style-three">
